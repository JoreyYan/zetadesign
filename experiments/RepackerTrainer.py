...
class argsx():
    def __init__(self):
        ...
        # trainmodel
        self.trainmodel='R'
        datapath= '//home/omnisky/data/everyOne/yjy/pdhs/dataset/'  #           # '/home/jorey/pdhs/dataset/'     #
        pro_path=  '/home/omnisky/data/everyOne/yjy/pdhs/' #'/home/jorey/pdhs/'#
        ...
        self.checkpoint= {
            ...
            'R_per_weight': pro_path+'/save/R/R_withbf_bfssecen_huberrmsd_lit_ml_finetune_E_3_0_8.pth',
            'resume_G':False,
    ...
    def save_checkpoints(self,epoch):
        prefix=self.trainmodel+str('_withbf_bfssecen_huberrmsd_lit_ml_finetune_E_4_')+str(self.R_param['bbrelaxdistance'])+'_'+str(epoch)
        torch.save({
